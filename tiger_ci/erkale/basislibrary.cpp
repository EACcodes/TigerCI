...
//#include "timer.h"
#include "erifit.h"
#include "custom_basis_library.h"
...
std::string find_basis(const std::string & basisname, bool verbose) {
  ...
  // TigerCI customization .. first look at where the basis lib was at compile time
  dirs.push_back(custom_basis_library() + std::string("/"));
