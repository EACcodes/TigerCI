#!/bin/bash
# from: http://tldp.org/LDP/abs/html/contributed-scripts.html with minor adoptions (JMD)
# * made things a little more strict and specialized for us
# * added Bessel correction to std dev -> sample std dev
...
sd () {
  ...
  do
    ...
    avg2=$(echo "scale=$SC; $sum2 / ($n - 1)" | bc)  # Avg. of sum of squares.
